...
const {login, forgotPassword,resetPassword,testing, refresh, users, blockusers,approveHotel,acceptHotel, deleteHotel, getHotelDetails, cmpltDetails, blockHotel, getSingleHotel, getAllBooking} = require('../controllers/adminController')

...
const {register,bookRoom, login, forgotPassword,resetPassword, validateMobile,otpSignIn,getHotels,getHotelImages,getSingleHotelData, countByCity, confirmBooking, verifyPayment, getBooking, retainHotelRoom, getUserWiseBooking, cancelBooking, updateBookedBy, payUsingWallet, searchCities, setReviewNotification, validateUserForReview, writeReview, addGuestDetails, deleteGuest, deleteReview, getHotelsByRating, getReviewForEdit, editReviewSubmit} = require("../controllers/userController")
...
router.put('/submit/edit/review/:id/:hotelId',editReviewSubmit)

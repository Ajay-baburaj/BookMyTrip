    ...
    return (
        <>
            <Container maxWidth={"lg"} sx={{ marginTop: 2 }}>
                ...
                <Typography fontSize={22} sx={{ lineHeight: 1.9, color: 'burlywood' }}>
                    {bookingData && bookingData?.hoteldetails?.name}
                </Typography>
                <Typography fontSize={14} color={'#484d49'}  >
                    {`${bookingData?.hoteldetails?.landmark} pincode: ${bookingData?.hoteldetails?.landmark}`}
                </Typography>
